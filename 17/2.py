                ...
                for pw in range(min_w - 1, max_w + 2):
                    ...
                    for r in range(-1,2):
                        for c in range(-1,2):
                            for z in range(-1,2):
                                for w in range(-1,2):
                                    if r == 0 and c == 0 and z == 0 and w == 0:
                                        continue
                                    check_pos = tuple(map(lambda i, j: i + j, pos, (r,c,z,w)))
